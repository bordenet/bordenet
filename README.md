...
- **[scripts](https://github.com/bordenet/scripts/blob/main/README.md)** – Simple, purpose-built tools and utilities. These are practical scripts I've written to solve specific problems—feel free to adopt, adapt, or build on them for your own use.
