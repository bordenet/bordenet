...
- **[superpowers-plus](https://github.com/bordenet/superpowers-plus)** - Extended skills for [obra/superpowers](https://github.com/obra/superpowers). 50 skills across 9 domains covering engineering workflows, wiki management, issue tracking, AI slop detection/elimination, security audits, observability, and systematic verification workflows.
