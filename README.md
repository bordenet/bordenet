...
- **[superpowers-plus](https://github.com/bordenet/superpowers-plus)** - Personal skills extending [obra/superpowers](https://github.com/obra/superpowers). Adds resume screening, AI slop detection, security upgrades, and the golden-agents generator. Includes install scripts for Claude Code, Augment, and Gemini.
