...
- **[superpowers-plus](https://github.com/bordenet/superpowers-plus)** - 86 skills for AI coding assistants, extending [obra/superpowers](https://github.com/obra/superpowers). Covers engineering workflows (blast radius, TDD, code review, design triad, pre-commit gates), wiki pipelines, issue tracking, slop detection/elimination, security scanning, planning/execution orchestration, and multi-agent coordination.
