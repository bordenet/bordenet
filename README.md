...
Engineering leader with 26+ years building platforms and leading teams at Amazon, Warner Bros. Discovery (iStreamPlanet), Stash Financial, Telepathy.AI, and now [**CallBox**](https://callbox.com). Working on [Cari](https://www.carwars.com/home/a/cari-phone-assist/), the AI phone assistant. Based in Seattle. **_I am hiring Staff/Principal engineers!_**
...
- [Engineering transformations with outcomes data](https://github.com/bordenet/Transformation_Case_Studies)
- [Engineering culture and leadership insights](https://github.com/bordenet/Engineering_Culture)

### Applications
- **[RecipeArchive](https://github.com/bordenet/RecipeArchive)** - Recipe manager with web, iOS, and Android support. Testing ground for AI-assisted development workflows.
...
- **[codebase-reviewer](https://github.com/bordenet/codebase-reviewer)** - AI-powered codebase analysis tool for systematic code review and onboarding.
...
**Note**: Additional Genesis-based tools expected next week.
