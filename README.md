...
- **[superpowers-plus](https://github.com/bordenet/superpowers-plus)** - 58 skills for AI coding assistants, extending [obra/superpowers](https://github.com/obra/superpowers). Covers engineering workflows (blast radius, TDD, code review, design triad), wiki pipelines, issue tracking, slop detection/elimination, security scanning, and observability.
